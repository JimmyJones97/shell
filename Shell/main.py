...
if __name__ == '__main__':
    ...
    # start
    in_apk_path = r'C:\Users\ChenD\OneDrive - bupt.edu.cn\working\TestApp\app\build\outputs\apk\debug\app-debug.apk'
    shell_app_base_dir = r'C:\Users\ChenD\OneDrive - bupt.edu.cn\working\ShellApp'
    shell_cpp_path = shell_app_base_dir + r'\app\src\main\cpp\dex'
    ...
    if os.path.exists(shell_cpp_path + '/' + shell.config_file.jni_func_name):
        os.remove(shell_cpp_path + '/' + shell.config_file.jni_func_name)
    shutil.move(shell.tmp_out_path + '/assets/' + shell.config_file.jni_func_name,
                shell_cpp_path + '/' + shell.config_file.jni_func_name)
    if os.path.exists(shell_cpp_path + '/' + shell.config_file.jni_func_header_name):
        os.remove(shell_cpp_path + '/' + shell.config_file.jni_func_header_name)
    shutil.move(shell.tmp_out_path + '/assets/' + shell.config_file.jni_func_header_name,
                shell_cpp_path + '/' + shell.config_file.jni_func_header_name)

    # rebuild shell apk by gradle
