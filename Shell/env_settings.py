...
FAKE_LIB_SO_DIR = os.path.abspath(FAKE_LIB_SO_DIR)
FAKE_LIB_SO_FILE_NAME = FAKE_LIB_SO_DIR + '/' + os.listdir(FAKE_LIB_SO_DIR)[0]
FAKE_LIB_SO_FILE_NAME = os.listdir(FAKE_LIB_SO_FILE_NAME)[0]
