...
#include "dex/DexFuck.h"
#include "so/SoFuck.h"
#include "dex/JNIFunc.h"
...
jint JNI_OnLoad(JavaVM *vm, void *unused) {
    ...
    // init DexFucker
    initDexFucker(&gDexFucker, gConfigFileProxy);
    // init SoFucker
    initSoFucker(&gSoFucker, gConfigFileProxy);
